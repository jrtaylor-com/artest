        ...
        t.exports = THREE.ColladaLoader = function(e) {
            ...
            parse: function(e, t) {
                ...
                function a(e) {
                    if (0 === e.length)
                        return [];
                    for (var t = e.trim().split(/\s+/), r = new Array(t.length), a = 0, n = t.length; a < n; a++)
                        r[a] = t[a];
                    return r
                }
                function n(e) {
                ...
                function l(e, t, a, n) {
                    var i = r(e, t)[0];
                    if (void 0 !== i)
                        for (var o = r(i, a), s = 0; s < o.length; s++)
                            n(o[s])
                }
                function u(e, t) {
                    for (var r in e) {
                                    ...
                                    for (var n = 0; n < 16; n++)
                                        !function(e, t, r) {
                                            ...
                                            for (n = 0, i = e.length; n < i; n++)
                                                void 0 === (a = e[n]).value[t] ? a.value[t] = null : o = !1;
                                            if (!0 === o)
                                                for (n = 0, i = e.length; n < i; n++)
                                                    (a = e[n]).value[t] = r;
                                            else
                ...
                function w(e) {
                    function t(e) {
                        ...
                        if (void 0 !== t) {
                            ...
                            console.warn("THREE.ColladaLoader: Undefined sampler. Access image directly (see #12530)."), r = y(e.id);
                        if (null !== r) {
                            var n = function(e) {
                                var t,
                            ...
                            if (void 0 !== n) {
                                ...
                                if (void 0 !== o && void 0 !== o.technique && !1 === c(o.technique)) {
                                    ...
                                    i.wrapS = THREE.RepeatWrapping, i.wrapT = THREE.RepeatWrapping;
                                return i
                            }
                                        ...
                                        for (var w in r) {
                                            ...
                                            case "POSITION":
                                                ...
                                                if (L(m, t[R], T.offset, n.array), n.stride = t[R].stride, t.skinWeights && t.skinIndices && (L(m, t.skinIndices, T.offset, l.array), L(m, t.skinWeights, T.offset, u.array)), !1 === m.hasUV && !0 === e.uvsNeedsFix)
                                                    for (var g = (n.array.length - x) / n.stride, A = 0; A < g; A++)
                                                        o.array.push(0, 0);
                                                break;
                                            case "NORMAL":
                ...
                function L(e, t, r, a) {
                    ...
                    if (void 0 !== e.vcount)
                        ...
                        for (var d = 0, f = i.length; d < f; d += o)
                            n(d)
                }
                function M(e) {
                ...
                function j(e, t) {
                    ...
                    for (r = 0; r < n.length; r++)
                        !1 === (a = n[r]).processed && (i.push(a), a.processed = !0);
                    var u = [],
                        d = [];
                ...
                function U(e) {
                    for (var t = [], r = e.matrix, a = e.nodes, n = e.type, i = e.instanceCameras, o = e.instanceControllers, s = e.instanceLights, c = e.instanceGeometries, l = e.instanceNodes, u = 0, d = a.length; u < d; u++)
                        t.push(q(a[u]));
                    ...
                    for (var u = 0, d = c.length; u < d; u++)
                        for (var b = c[u], T = M(b.id), v = 0, E = (h = G(T, b.materials)).length; v < E; v++)
                            t.push(h[v]);
                    for (var u = 0, d = l.length; u < d; u++)
                        t.push(q(l[u]).clone());
                    var w;
                    if (0 === a.length && 1 === t.length)
                        w = t[0];
                    else {
                ...
                l(ee, "library_animations", "animation", function(e) {
                            ...
                            case "channel":
                                i = n.getAttribute("target"), t.channels[i] = function(e) {
                                    var t = {},
                                        ...
                                        s = -1 !== n.indexOf(".");
                                    if (s)
                                        r = n.split("."), n = r.shift(), t.member = r.shift();
                                    else if (i) {
                                        var c = n.split("(");
                                        n = c.shift();
                    ...
                    for (var t = {
                        ...
                        if (1 === a.nodeType)
                            switch (a.nodeName) {
                            case "rigid_body":
                                t.rigidBodies[a.getAttribute("name")] = {}, function(e, t) {
                                    for (var r = 0; r < e.childNodes.length; r++) {
                                        var a = e.childNodes[r];
                                        if (1 === a.nodeType)
                                            switch (a.nodeName) {
                ...
                }), u(ce.animations, f), u(ce.clips, h), u(ce.controllers, v), u(ce.images, E), u(ce.effects, T), u(ce.materials, w), u(ce.cameras, x), u(ce.lights, N), u(ce.geometries, C), u(ce.visualScenes, W), function() {
                    var e = ce.clips;
                    if (!0 === c(e)) {
                            ...
                            setJointValue: function(e, t) {
                                ...
                                if (r) {
                                    ...
                                    if (t > a.limits.max || t < a.limits.min)
                                        console.warn("THREE.ColladaLoader: Joint " + e + " value " + t + " outside of limits (min: " + a.limits.min + ", max: " + a.limits.max + ").");
                                    else if (a.static)
            ...
            e.prototype = {
                ...
                parse: function(e, r) {
                    if (function(e) {
                        ...
                        if (l(a) < 7e3)
                            throw new Error("THREE.FBXLoader: FBX version not supported, FileVersion: " + l(a));
                        g = (new i).parse(a)
                    }
                ...
                parseImage: function(e) {
                    ...
                    case "tga":
                        if ("function" != typeof THREE.TGALoader)
                            return void console.warn("FBXLoader: THREE.TGALoader is required to load TGA textures");
                ...
                loadTexture: function(e, t) {
                    ...
                    if ("tga" === o) {
                        ...
                        "psd" === o ? (console.warn("FBXLoader: PSD textures are not supported, creating empty placeholder texture for", r), i = new THREE.Texture) : i = this.textureLoader.load(r);
                ...
                parseMaterial: function(e, t) {
                    var r = e.id,
                        a = e.attrName,
                        i = e.ShadingModel;
                    if ("object" === (void 0 === i ? "undefined" : n(i)) && (i = i.value), !E.has(r))
                        return null;
                    var o,
                ...
                parseMorphTargets: function(e, t) {
                    for (var r = [], a = 0; a < e.children.length; a++) {
                        ...
                        if ("BlendShapeChannel" !== i.attrType)
                            return;
                ...
                genFace: function(e, t, r, a, n, i, o, s, c, l) {
                    for (var u = 2; u < l; u++)
                        e.vertex.push(t.vertexPositions[r[0]]), e.vertex.push(t.vertexPositions[r[1]]), e.vertex.push(t.vertexPositions[r[2]]), e.vertex.push(t.vertexPositions[r[3 * (u - 1)]]), e.vertex.push(t.vertexPositions[r[3 * (u - 1) + 1]]), e.vertex.push(t.vertexPositions[r[3 * (u - 1) + 2]]), e.vertex.push(t.vertexPositions[r[3 * u]]), e.vertex.push(t.vertexPositions[r[3 * u + 1]]), e.vertex.push(t.vertexPositions[r[3 * u + 2]]), t.skeleton && (e.vertexWeights.push(s[0]), e.vertexWeights.push(s[1]), e.vertexWeights.push(s[2]), e.vertexWeights.push(s[3]), e.vertexWeights.push(s[4 * (u - 1)]), e.vertexWeights.push(s[4 * (u - 1) + 1]), e.vertexWeights.push(s[4 * (u - 1) + 2]), e.vertexWeights.push(s[4 * (u - 1) + 3]), e.vertexWeights.push(s[4 * u]), e.vertexWeights.push(s[4 * u + 1]), e.vertexWeights.push(s[4 * u + 2]), e.vertexWeights.push(s[4 * u + 3]), e.weightsIndices.push(c[0]), e.weightsIndices.push(c[1]), e.weightsIndices.push(c[2]), e.weightsIndices.push(c[3]), e.weightsIndices.push(c[4 * (u - 1)]), e.weightsIndices.push(c[4 * (u - 1) + 1]), e.weightsIndices.push(c[4 * (u - 1) + 2]), e.weightsIndices.push(c[4 * (u - 1) + 3]), e.weightsIndices.push(c[4 * u]), e.weightsIndices.push(c[4 * u + 1]), e.weightsIndices.push(c[4 * u + 2]), e.weightsIndices.push(c[4 * u + 3])), t.color && (e.colors.push(i[0]), e.colors.push(i[1]), e.colors.push(i[2]), e.colors.push(i[3 * (u - 1)]), e.colors.push(i[3 * (u - 1) + 1]), e.colors.push(i[3 * (u - 1) + 2]), e.colors.push(i[3 * u]), e.colors.push(i[3 * u + 1]), e.colors.push(i[3 * u + 2])), t.material && "AllSame" !== t.material.mappingType && (e.materialIndex.push(a), e.materialIndex.push(a), e.materialIndex.push(a)), t.normal && (e.normal.push(n[0]), e.normal.push(n[1]), e.normal.push(n[2]), e.normal.push(n[3 * (u - 1)]), e.normal.push(n[3 * (u - 1) + 1]), e.normal.push(n[3 * (u - 1) + 2]), e.normal.push(n[3 * u]), e.normal.push(n[3 * u + 1]), e.normal.push(n[3 * u + 2])), t.uv && t.uv.forEach(function(t, r) {
                ...
                parseNurbsGeometry: function(e) {
                    ...
                    if (isNaN(t))
                        return console.error("THREE.FBXLoader: Invalid Order %s given for geometry ID: %s", e.Order, e.id), new THREE.BufferGeometry;
                    for (var r = t - 1, a = e.KnotVector.a, n = [], i = e.Points.a, o = 0, s = i.length; o < s; o += 4)
                ...
                generateRotationTrack: function(e, t, r, a, n) {
                    ...
                    for (var s = new THREE.Quaternion, c = new THREE.Euler, l = [], u = 0; u < o.length; u += 3)
                        c.set(o[u], o[u + 1], o[u + 2], "ZYX"), s.setFromEuler(c), void 0 !== a && s.premultiply(a), void 0 !== n && s.multiply(n), s.toArray(l, u / 3 * 4);
                ...
                interpolateRotations: function(e) {
                    for (var t = 1; t < e.values.length; t++) {
                        var r = e.values[t - 1],
                            ...
                            n = Math.abs(a);
                        if (n >= 180) {
                            for (var i = n / 180, o = a / i, s = r + o, c = e.times[t - 1], l = (e.times[t] - c) / i, u = c + l, d = [], f = []; u < e.times[t];)
                ...
                parseNodeProperty: function(e, t, r) {
                    ...
                    if ("Properties70" !== i.name) {
                        ...
                        this.parseNodeSpecialProperty(e, a, n)
                },
                ...
                parseSubNode: function(e, t, r) {
                    if (!0 === r.singleProperty) {
                        ...
                        void 0 === t[r.name] ? "number" == typeof r.id ? (t[r.name] = {}, t[r.name][r.id] = r) : t[r.name] = r : "PoseNode" === r.name ? (Array.isArray(t[r.name]) || (t[r.name] = [t[r.name]]), t[r.name].push(r)) : void 0 === t[r.name][r.id] && (t[r.name][r.id] = r)
                },
        ...
        t.exports = AFRAME.registerComponent("animation-mixer", {
            ...
            stopAction: function() {
                for (var e = this.data, t = 0; t < this.activeActions.length; t++)
                    e.crossFadeDuration ? this.activeActions[t].fadeOut(e.crossFadeDuration) : this.activeActions[t].stop();
